---
lab:
  title: Menjalankan alur di Azure Machine Learning
---

# Menjalankan alur di Azure Machine Learning

Anda dapat menggunakan Python SDK untuk melakukan semua tugas yang diperlukan untuk membuat dan mengoperasikan solusi pembelajaran mesin di Azure. Daripada melakukan tugas-tugas ini satu per satu, Anda dapat menggunakan alur untuk mengatur langkah-langkah yang diperlukan untuk menyiapkan data, menjalankan skrip pelatihan, dan tugas lainnya.

Dalam latihan ini, Anda akan menjalankan beberapa skrip sebagai pekerjaan alur.
...
Kode untuk membangun dan mengirimkan alur dengan Python SDK disediakan dalam buku catatan. 

1. Buka **buku catatan Labs/09/Jalankan alur job.ipynb** .
