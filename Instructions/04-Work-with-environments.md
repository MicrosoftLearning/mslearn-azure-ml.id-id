---
lab:
  title: Bekerja dengan lingkungan di Azure Machine Learning
---

# Bekerja dengan lingkungan di Azure Machine Learning

Untuk menjalankan notebook dan skrip, Anda harus memastikan bahwa paket yang diperlukan diinstal. Lingkungan memungkinkan Anda menentukan runtime dan paket Python yang harus digunakan oleh komputasi Anda untuk menjalankan kode Anda.

Dalam latihan ini, Anda akan mempelajari tentang lingkungan dan cara menggunakannya saat melatih model pembelajaran mesin dengan komputasi Azure Machine Learning.
...
Setelah membuat ruang kerja dan sumber daya komputasi yang diperlukan, Anda dapat membuka studio Azure Machine Learning dan mengkloning materi lab. 
...
Kode untuk membuat dan mengelola lingkungan dengan Python SDK disediakan dalam buku catatan. 

1. Buka buku catatan **Labs/04/Work with environments.ipynb** .
