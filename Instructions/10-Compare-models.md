---
lab:
  title: Membandingkan dan mengevaluasi model
---

# Membandingkan dan mengevaluasi model

Setelah melatih model, Anda mungkin ingin mengevaluasi model untuk menjelajahi apakah model berfungsi seperti yang diharapkan. Di samping metrik performa, ada faktor lain yang dapat Anda pertimbangkan. Dasbor AI yang bertanggung jawab di Azure Machine Learning memungkinkan Anda menganalisis data dan prediksi model untuk mengidentifikasi bias atau ketidakwajaran apa pun.

Dalam latihan ini, Anda akan menyiapkan data dan membuat dasbor AI yang bertanggung jawab di Azure Machine Learning.
...
## Mengirimkan pekerjaan MLflow dari buku catatan
...
1. Buka buku catatan **Labs/10/Create Responsible AI dashboard.ipynb** .
